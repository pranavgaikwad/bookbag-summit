...
Additionally, temporary object storage will be required perform a migration. For +
example, this can be provided through: https://aws.amazon.com/s3/[AWS S3], +
...
As we will be interacting with both the source and destination cluster throughout +
the course of this lab, let’s go ahead and open two terminal windows.
